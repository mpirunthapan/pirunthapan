...
const Services = () => {
  return (
    ...
    className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
        I am a software engineer from Sri Lanka with one year experience in software development and web development, committed to continuously enhancing my skills and expanding my professional experience.
    </motion.p>
