...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "4fda0d30-8573-42ff-a696-526385365e29");
  ...
  return (
    ...
    id='contact' className='w-full px-[12%] py-10 scroll-mt-10 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
    ...
    transition={{duration: 0.5, delay: 0.7}}className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
        I'd love to hear from you! If you have any questions, comments, or a feedback, please use the form below.
    </motion.p>
    ...
    onSubmit={onSubmit} className='max-w-2xl mx-auto'>
      <div className='grid grid-cols-auto gap-6 mt-10 mb-8'>
        ...
        type="text" placeholder='Enter your mail' required className='flex-1 p-3 outline-none border-[0.5px] border-gray-400 rounded-md bg-white dark:bg-darkHover/30 dark:border-white/90' name='email'/>
      ...
      type='submit' id='contact-submit-btn'
